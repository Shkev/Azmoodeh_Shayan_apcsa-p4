...
public class ElevensBoard extends Board {
	...
	{
		//checks all pairs of cards in selectedCards
	...
	private boolean containsJQK(List<Integer> selectedCards) 
	{
		...
		{
			if(cardAt(n.intValue()).rank().equals("king"))
				king++;
			if(cardAt(n.intValue()).rank().equals("queen"))
				queen++;
			if(cardAt(n.intValue()).rank().equals("jack"))
				jack++;
		}
